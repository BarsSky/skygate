...
[![CI](https://github.com/skygate-operator/skygate/actions/workflows/ci.yml/badge.svg)](https://github.com/skygate-operator/skygate/actions/workflows/ci.yml)
...
Дефолтный админ: `admin` + пароль из `SKYGATE_ADMIN_PASS`.
...
- **Nginx Proxy Manager**: proxy host `skygate.example.com` →
  `http://192.0.2.1:8080`, LE-сертификат, force SSL.
- **Caddy** (одной строкой):
  ```
  skygate.example.com {
...
- ✅ Per-user лимиты правил (`SKYGATE_USER_MAX_RULES=admin:2000,alice:500`)
...
[MIT](LICENSE) — Copyright (c) 2026 skygate-operator. Использование, изменение
и распространение разрешены на условиях лицензии MIT. Полный текст —
...
проект Juan Font. Skygate — независимый self-service портал, не
аффилированный и не одобренный ни одним из этих проектов.
