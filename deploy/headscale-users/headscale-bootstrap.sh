...
#
# Creates:
#   - /home/admin/headscale/users/<username>/config/config.yaml
#   - /home/admin/headscale/users/<username>/data/
#   - /home/admin/headscale/docker-compose.user-<username>.yml
...
GLOBAL_HEADSCALE_DIR="${SKYGATE_HEADSCALE_DIR:-/home/admin/headscale}"
