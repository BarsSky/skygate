...
#
# This script runs ON THE RELAY HOST (e.g. relay-1), not on skygate.
...
#      running and is logged in to head.example.com).
...
echo "  1. SSH to head.example.com"
...
echo "  https://head.example.com/ → Machines → this relay → Approve advertised routes"
echo
