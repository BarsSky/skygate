...
ssh skyadmin@192.168.13.69 "cd /home/skyadmin/skygate && git pull && docker compose up -d skygate"
...
- skygate-vm pings `8.8.8.8` via emilia with 0% loss
- `https://skygate.skynas.ru/healthz` → 200
