...
- Polls `https://api.github.com/repos/skygate-operator/skygate/releases/latest`
...
```
https://github.com/skygate-operator/skygate/releases/download/v0.29.0/skygate-linux-amd64
https://github.com/skygate-operator/skygate/releases/download/v0.29.0/skygate-linux-amd64.sha256
```
...
curl -fsSL -o skygate.v0.29.0 https://github.com/skygate-operator/skygate/releases/download/v0.29.0/skygate-linux-amd64
curl -fsSL -o skygate.v0.29.0.sha256 https://github.com/skygate-operator/skygate/releases/download/v0.29.0/skygate-linux-amd64.sha256
...
│  Your install:   Docker compose (admin@192.0.2.1)    │
