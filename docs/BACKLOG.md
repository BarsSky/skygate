...
## Priority 3 — HA "svyatoslava" / Tier 1 hot standby (BLOCKED on 2nd VM + etcd quorum + S3)
...
- Active-passive: 2nd VM (svyatoslava) is the warm standby
- Old VM (192.168.13.69) becomes the replica
