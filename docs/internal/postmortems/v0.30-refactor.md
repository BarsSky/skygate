...
The motivation is documented in `docs/internal/historical/refactor-v0.30-plan.md`
...
- **No documentation drift** — the AGENTS.md "Code structure
  ...
  `docs/internal/postmortems/v0.30-refactor.md` (this file).
...
| Date | Event |
|---|---|
| 2026-07-25 | `docs/internal/historical/refactor-v0.30-plan.md` written, 8-day estimate |
