...
exercised on the production VM: user1 → `10.0.6.0/24`,
guest → `10.0.9.0/24`, user2 → `10.0.10.0/24`. Skyadmin
...
1|admin|10.0.1.0/24|active
6|user1|10.0.6.0/24|pending
9|guest|10.0.9.0/24|pending
10|user2|10.0.10.0/24|pending
```
