...
3. `POST /my/meshes/join` (same code, admin is already
...
3/3 (relay-1, relay-2, relay-3). The check_https step
...
scp check_v0.22.1.sh admin@<vm>:/tmp/
ssh admin@<vm> "chmod +x /tmp/check_v0.22.1.sh && bash /tmp/check_v0.22.1.sh"
