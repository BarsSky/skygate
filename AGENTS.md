...
it tracks abandoned / blocked / in-progress features (HA svyatoslava,
...
* **Previous**: v0.30.1 — per-user device can't be tagged as exit-node
  ...
  The "base" fix. michail's Windows box "base" had silently
...
* **Previous**: v0.29.0 — Self-update orchestrator (in-app upgrade + auto-rollback)
  ...
  /home/skyadmin/skygate/data/). 5 post-Phase-2 bugfixes
...
ssh skyadmin@192.168.13.69 'sudo cp /home/skyadmin/skygate/deploy/skygate-cli.sh /usr/local/bin/skygate && sudo chmod +x /usr/local/bin/skygate'
