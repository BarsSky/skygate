...
* **Current**: v0.26.0 — end-to-end subnet-router pilot + HA-ready
  probes ([tag v0.26.0](https://github.com/skygate-operator/skygate/releases/tag/v0.26.0)).
...
- `acl/acl.go` (190) — GenerateACL as a free function so the bot (no *App) can reuse it; per-user policy + ssh rules + tagOwners. v7 added tag:exit-node to tagOwners + admin→tag:public SSH rule.
