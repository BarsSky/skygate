...
- Admin (admin) creates portal users in `/admin/users`
...
HEADSCATE_URL=http://192.0.2.1:50444
...
HEADSCALE_URL=http://relay-3.example.com:50444
```
...
4. Create `.env` from the example:
   ...
   HEADSCALE_URL=http://localhost:50444     # if headscale also runs on Windows
                                             # or http://192.0.2.1:50444 for LAN
   ```
