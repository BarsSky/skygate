...
ssh -o ConnectTimeout=5 -o StrictHostKeyChecking=accept-new -o BatchMode=yes skyadmin@192.168.13.20 'ping -c 3 -W 4 45.152.198.217 2>&1 | tail -6' 2>&1
echo ""
...
ssh -o ConnectTimeout=5 -o StrictHostKeyChecking=accept-new -o BatchMode=yes skyadmin@192.168.13.20 'nc -zv -w 3 45.152.198.217 22 2>&1; echo "---"; nc -zv -w 3 45.152.198.217 80 2>&1; echo "---"; nc -zv -w 3 45.152.198.217 443 2>&1; echo "---"; nc -zv -w 3 45.152.198.217 2379 2>&1' 2>&1
echo ""
echo "=== From 13.20, ssh to svyatoslava public IP ==="
ssh -o ConnectTimeout=5 -o StrictHostKeyChecking=accept-new -o BatchMode=yes skyadmin@192.168.13.20 'ssh -o ConnectTimeout=3 -o StrictHostKeyChecking=accept-new -o BatchMode=yes skyadmin@45.152.198.217 "echo SSH_OK" 2>&1' 2>&1 | head -3
echo ""
