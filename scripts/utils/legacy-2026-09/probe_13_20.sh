...
ssh -o ConnectTimeout=8 -o BatchMode=yes skyadmin@192.168.13.20 'ping -c 3 -W 3 <polygon-vm-public-ip> 2>&1 | tail -6' 2>&1
echo ""
...
ssh -o ConnectTimeout=8 -o BatchMode=yes skyadmin@95.165.170.190 'ping -c 3 -W 3 <polygon-vm-public-ip> 2>&1 | tail -6' 2>&1
echo ""
...
ssh -o ConnectTimeout=8 -o BatchMode=yes skyadmin@95.165.170.190 'ssh -o ConnectTimeout=3 -o BatchMode=yes skyadmin@<polygon-vm-public-ip> "echo SSH_OK" 2>&1' 2>&1 | head -5
