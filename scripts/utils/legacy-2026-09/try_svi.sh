...
echo ""
echo "=== try 'root@svyatoslava-1' from this Windows host ==="
ssh -o ConnectTimeout=5 -o StrictHostKeyChecking=accept-new -o BatchMode=yes root@svyatoslava-1 "echo SSH_OK; whoami; hostname" 2>&1 | head -5
echo ""
echo "=== try 'root@45.152.198.217' from this Windows host ==="
ssh -o ConnectTimeout=5 -o StrictHostKeyChecking=accept-new -o BatchMode=yes root@45.152.198.217 "echo SSH_OK; whoami; hostname" 2>&1 | head -5
echo ""
echo "=== from skygate: try 'root@svi' / 'root@svyatoslava-1' ==="
