...
#
# Reads secrets from /home/admin/skygate/.env (TELEGRAM_BOT_TOKEN, TELEGRAM_CHAT_ID,
# optional TELEGRAM_API).
# If unset → silent fallback to local log at /home/admin/.skygate-notify.log.
#
# Usage:
...
SKYGATE_DIR="${SKYGATE_DIR:-/home/admin/skygate}"
