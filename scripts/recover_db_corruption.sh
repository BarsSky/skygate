...
# (set in /home/skyadmin/skygate/.env).
#
...
ADMIN_USER=$($SSH 'grep SKYGATE_ADMIN_USER /home/skyadmin/skygate/.env | cut -d= -f2-')
ADMIN_PASS=$($SSH 'grep SKYGATE_ADMIN_PASS /home/skyadmin/skygate/.env | cut -d= -f2-')
ADMIN_USER=${ADMIN_USER:-skyadmin}

echo "=== 1. Stop skygate ==="
$SSH 'cd /home/skyadmin/skygate && sudo docker compose stop skygate' 2>&1 | tail -2
...
sudo cp /home/skyadmin/skygate/data/skygate.db $BACKUP_DIR/skygate.db
...
$SSH "sqlite3 /home/skyadmin/skygate/data/skygate.db <<'SQL'
...
$SSH 'cd /home/skyadmin/skygate && sudo docker compose up -d --no-deps skygate' 2>&1 | tail -2
