...
run_check "B131" "Linear theme contrast bump: :root colors lifted (--bg #0e0f12, --bg-card #1a1c21, --bg-elev #25282e, --border #383b42, --header-bg #15171c) + alert opacities bumped from 0.10 to 0.15 + input backgrounds use var(--bg-elev) (was hardcoded #1a1a1a) + sRGB contrast >=5% (B131, v1.3.20.1 — fixes the operator's 'Linear theme breaks all perception' complaint; pre-B131 cards blended into bg, header was invisible, alerts were barely readable)" \
