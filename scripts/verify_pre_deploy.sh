...
# cause analysis + fix procedure in docs/internal/historical/tailnet-diagnostics.md.
...
#   4. docs/internal/historical/tailnet-diagnostics.md has the 5 mandatory sections
...
# 2026-09-14 documentation audit (docs/internal/audits/doc-audit.md):
