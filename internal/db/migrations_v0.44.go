...
//      IP from the 100.64.100.0/10 pool). When that happens,
//      the rule with src=100.64.100.1 silently stops
...
//      to workstation-1 can land on workstation-3 if headscale hands
//      workstation-3 the IP that was workstation-1's yesterday.
//
