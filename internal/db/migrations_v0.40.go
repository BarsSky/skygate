...
// nicer primitive than "100.64.100.2":
...
//     might be 100.64.100.2 (the relay's tailnet IP) and
...
// (e.g. "11" for relay-3). Empty string = no preference;
...
func migrationV040(d *sql.DB) error {
	stmts := []string{
		...
		// (e.g. "11" for relay-3). Empty = no preference.
