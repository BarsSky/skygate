...
// (parseSubnetRouterHostname was removed in v0.34 — the
// v0.23.0 migration replaced it with UsernameFromHostname +
// UserIDFromUsername, and the legacy alias that returned
// (0, true) when given a parseable name was a footgun.
// All callers now go through the public helpers.)
