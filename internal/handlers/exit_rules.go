...
func (a *App) GenerateACL() (string, error) {
	...
	sb.WriteString("    \"tag:public\": [\"admin@tsnet.example.com\"],\n")
	sb.WriteString("    \"tag:exit-node\": [\"admin@tsnet.example.com\"],\n")
	sb.WriteString("    \"tag:client\": [\"admin@tsnet.example.com\"],\n")
	sb.WriteString("    \"tag:private\": [\"admin@tsnet.example.com\"]\n")
	sb.WriteString("  },\n")
	sb.WriteString("  \"groups\": {\n")
	sb.WriteString("    \"group:admin\": [\"admin@tsnet.example.com\"]\n")
	sb.WriteString("  },\n")
	sb.WriteString("  \"ssh\": [\n")
	sb.WriteString("    {\n")
	sb.WriteString("      \"action\": \"accept\",\n")
	sb.WriteString("      \"src\": [\"tag:private\", \"admin@tsnet.example.com\"],\n")
