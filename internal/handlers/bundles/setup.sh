...
#   - Be logged in to https://head.example.com as
...
# OTHER users' subnets (so a subnet-router in user1's network
# can reach admin's 10.0.1.0/24 if shared). It does NOT
...
echo "       # or, if the skygate configures base_domain = tsnet.example.com:"
