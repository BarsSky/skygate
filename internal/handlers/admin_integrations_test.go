...
func TestGetAdminIntegrations_200ForAdmin(t *testing.T) {
	app, d := newTestApp(t, &testNotifier{})
	defer d.Close()
	req := authedReqFor(t, app, "GET", "/admin/integrations", nil, "admin")
	w := httptest.NewRecorder()
	app.withTemplates()
	app.GetAdminIntegrations(w, req)
...
func TestPostAdminDerpConfig_PersistsAndReflects(t *testing.T) {
	...
	req := authedReqFor(t, app, "POST", "/admin/derp/config", form, "admin")
	w := httptest.NewRecorder()
...
func TestPostAdminHeadplane_PersistsAndPreservesDerp(t *testing.T) {
	...
	req1 := authedReqFor(t, app, "POST", "/admin/derp/config", form1, "admin")
	...
	req2 := authedReqFor(t, app, "POST", "/admin/headplane", form2, "admin")
...
func TestPostAdminHeadplane_RejectsInvalidMode(t *testing.T) {
	...
	req := authedReqFor(t, app, "POST", "/admin/headplane", form, "admin")
	w := httptest.NewRecorder()
