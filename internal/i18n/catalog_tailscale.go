...
var ruTailscale = map[string]string{
	...
	"tailscale.status_ip":                 "IP в tailnet",
	"tailscale.status_ip_empty":           "не назначен",
	"tailscale.status_backend":            "Состояние бэкенда",
	...
	"tailscale.auth_heading":              "Ключ авторизации",
	...
	"tailscale.auth_textarea_label":       "Ключ авторизации (preauth)",
	...
	"tailscale.login_server_heading":      "URL headscale (сервер входа)",
