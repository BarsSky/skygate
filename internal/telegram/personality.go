...
const (
	...
	// (headerFooterSeparator was removed in v0.34 — the v0.18
	// refactor inlined the "\n\n" directly into headerFor +
	// footerFor. The constant was a 2026-07 refactor leftover.)
)
...
// (ruleBreak was removed in v0.34 — it was the v1 inter-section
// rule, but the v0.18 Compose() rewrite inlined thinRule into
// the body where it's needed and no caller used ruleBreak()
// directly.)
