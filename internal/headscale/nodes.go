...
//     without an explicit tag (this is how relay-3/relay-1/relay-2
...
func hasExitNodeTag(tags []string, name string, availableRoutes []string) bool {
	...
	//    the whole internet). This is how our relay-3/relay-1/relay-2
...
// as the Android device (workstation-2 / node 10) being unable to stay
