...
func runBackupScript(dest string) (string, int64, error) {
	...
	// should always be there; the /home/admin/...
	// fallback is for direct-host invocations via cron.
	scriptPath := ""
	for _, try := range []string{
		"/app/scripts/backup.sh",
		"/home/admin/skygate/scripts/backup.sh",
	} {
	...
	if scriptPath == "" {
		return "", 0, fmt.Errorf("backup.sh not found in /app/scripts or /home/admin/skygate/scripts")
	}
