...
func TestFormatAlert(t *testing.T) {
	...
	latest := &Release{
		...
		HTMLURL:     "https://github.com/skygate-operator/skygate/releases/tag/v0.10.8",
	...
	for _, want := range []string{"v0.10.7", "v0.10.8", "2026-07-15", "github.com/skygate-operator/skygate/releases/tag/v0.10.8"} {
