...
type Subnet struct {
	...
	// ID (e.g. "11" for relay-3) and the ACL builder
	...
	// route is per-user; relay-3 is the operator's
	// choice for user1, but alice might prefer
	// relay-1 (lower latency from her VPS).
