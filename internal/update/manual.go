...
// is /home/skyadmin/skygate (bind-mounted into the container
...
func GenerateBareSteps(current, target string) ManualSteps {
	...
	return ManualSteps{
		...
		Steps: []string{
			...
			"  https://github.com/BarsSky/skygate/releases/download/" + target + "/skygate-linux-amd64",
			"curl -fsSL -o skygate." + shortTarget + ".sha256 \\",
			"  https://github.com/BarsSky/skygate/releases/download/" + target + "/skygate-linux-amd64.sha256",
