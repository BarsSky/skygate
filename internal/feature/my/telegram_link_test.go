...
func TestTelegramDeepLinkShape(t *testing.T) {
	u := buildTelegramDeepLinkURL("example.com", "skg-AAAA-BBBB-CCCC", "admin")
	if !strings.HasPrefix(u, "https://example.com/my/telegram/qr?") {
...
func TestTelegramDeepLinkEmptyUsername(t *testing.T) {
	u := buildTelegramDeepLinkURL("example.com", "skg-AAAA-BBBB-CCCC", "")
...
func TestTelegramDeepLinkEmptyToken(t *testing.T) {
	u := buildTelegramDeepLinkURL("example.com", "", "admin")
	if !strings.HasPrefix(u, "https://example.com/my/telegram/qr?") {
...
func TestTelegramDeepLinkNoSpecialsInToken(t *testing.T) {
	for _, tok := range []string{
		...
		u := buildTelegramDeepLinkURL("example.com", tok, "admin")
