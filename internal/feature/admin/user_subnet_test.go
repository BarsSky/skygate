...
//     for <span class="user-name">skyadmin — render-dependent
//
...
func TestPostAdminUserSubnetAllocateAndDisable(t *testing.T) {
	...
	// Allocate.
	allocReq := authedReqFor(t, "POST", "/admin/users/"+itoa(uid)+"/subnet/allocate", nil, "skyadmin", true)
	...
	getReq := authedReqFor(t, "GET", "/admin/users/"+itoa(uid)+"/subnet", nil, "skyadmin", true)
	...
	allocReq2 := authedReqFor(t, "POST", "/admin/users/"+itoa(uid)+"/subnet/allocate", nil, "skyadmin", true)
	...
	// Disable.
	disReq := authedReqFor(t, "POST", "/admin/users/"+itoa(uid)+"/subnet/disable", nil, "skyadmin", true)
...
func TestPostAdminUserSubnetTestSanity(t *testing.T) {
	...
	testReq := authedReqFor(t, "POST", "/admin/users/"+itoa(uid)+"/subnet/test", nil, "skyadmin", true)
...
func TestPostAdminUserSubnetProvision_IssuesPreauthAndShows(t *testing.T) {
	...
	provReq := authedReqFor(t, "POST", "/admin/users/"+itoa(uid)+"/subnet/provision", nil, "skyadmin", true)
